 ...
 * @author vishnu.g
 */
public class InMemoryCacheWithLRUEvictionTest {

    @Test
    public void testSimpleCache() {
        Cache<String, String> simpleCache = new InMemoryCacheWithLRUEviction<>();
    ...
    public void testLRUEviction() {
        Cache<String, String> simpleCache = new InMemoryCacheWithLRUEviction(4);
        simpleCache.put("1", "one");
        simpleCache.put("2", "two");
    ...
    public void testCacheKeyExpiry() throws InterruptedException {
        ...
        Thread.sleep(100);
        simpleCache.put("2", "two", 500);
        Thread.sleep(100);
        simpleCache.put("3", "three", 500);
        Thread.sleep(100);
